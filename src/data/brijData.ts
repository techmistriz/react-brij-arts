...
export const aims = [
  ...
  "Be a space for interdisciplinary exploration across the arts.",
  "Be a vehicle for cultural diplomacy.",
  "Be a driver for arts education.",
...
export const elements = [
  {
    ...
    image: brijElement1,
    description:
      "Including formal post graduate education as well as mentorship, internships, residencies and a publishing wing with a focus on writing and research.",
  },
  {
    title: "Multidisciplinary Experiences",
    image: brijElement2,
    description:
      "With a Museum housing interactive exhibits, performances taking place in the Auditoria, Arena and Black Box, culinary experiences, Library and Archives and immersive projects for audiences to engage with.",
  },
  {
    title: "Innovation & Incubation",
    image: brijElement3,
    description:
      "Spaces for experimenting and honing skills in workshop areas, an Incubation Centre, Labs & Studios, an Accelerator and a Material Library.",
  },
];
...
export const boardAdvisors = [
  {
    name: "Sir Peter Bazalgette",
    image: "https://thebrij.world/wp-content/uploads/2022/12/Rectangle-5-4-1-500x450.png",
    bio: "The current Chairperson of the Royal College of Arts (UK), ex-Chairman of Endemol UK, and a celebrated British television personality.",
  },
  {
    name: "Harsh Goenka",
    image: "https://thebrij.world/wp-content/uploads/2022/12/Rectangle-5-4-2-500x450.png",
    bio: "The Chairman of RPG Group, and noted industrialist and corporate leader from India. An ardent art collector and a strong advocate of innovation.",
  },
  {
    name: "Deepak Iyer",
    image: "https://thebrij.world/wp-content/uploads/2022/12/Rectangle-5-4-3-500x450.png",
    bio: "Leader of the Accenture Microsoft Business Group for Southeast Asia, with over 22 years of extensive experience in Digital Innovation and IT Strategy.",
  },
];
