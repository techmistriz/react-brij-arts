            ...
            <div className="space-y-20 md:space-y-28">
              ...
              >
                <div className="grid md:grid-cols-2 gap-8 md:gap-24">
                  ...
                  <div className="space-y-5">
                    <p className="text-muted-foreground leading-relaxed">
                      In Reconfirm section H of the individual application form, simply check the box labelled "I would like to apply for a bursary" and attach any supporting documentation.
                    </p>
                    <p className="text-muted-foreground leading-relaxed">
              ...
              >
                <div className="grid md:grid-cols-2 gap-8 md:gap-24">
                  ...
                  <div className="space-y-5">
                    <p className="text-muted-foreground leading-relaxed">
                      Bursary decisions are made by the independent committee after selection decisions have been confirmed, using the financial need responses. Bursaries are awarded at one of three levels:
                    </p>
              ...
              >
                <div className="grid md:grid-cols-2 gap-8 md:gap-24">
                  ...
                  <div className="space-y-5">
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      Bursaries are awarded after selection — all Fellows are selected on merit first. The bursary section of the application is seen only by the Bursary Committee, never by the jury.
                    </p>
                  </div>
                </div>
              </motion.div> */}
